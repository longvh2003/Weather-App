$(document).ready(function() {
    ...
    function renderWeather(weather) {
        ...
        <hr />
        <div class="weather-detail-container row justify-content-center">
            <div class="item toggle-units col-6">
            ...
            <div class="item col-6 ">
                <p class="justify-content-center">Humidity: ${humidity} %</p>
                <p class="justify-content-center">Pressure: ${pressure} hPa</p>
            </div>
        </div>`);
    }
